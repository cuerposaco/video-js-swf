    ...
    public class VideoJS extends Sprite{
        ...
        private function registerExternalMethods():void{
            ...
            try{
                ...
                ExternalInterface.addCallback("vjs_setAdConfig" , onAdConfigCalled );
        ...
        private function finish():void{
            ...
            _app.model.broadcastEventExternally( 'getVpData' );
        ...
        private function onAdConfigCalled(data:Object):void{
            trace('---- onAdConfigCalled');
            var _ctxAbout:ContextMenuItem = new ContextMenuItem("VideoPlaza Setted!!!!", false, false);
            var _ctxMenu:ContextMenu = new ContextMenu();
